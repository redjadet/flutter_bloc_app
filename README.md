...
The workflow stays model-agnostic: Codex, Cursor, Claude Code, Gemini, any AI models including open-source/weight self-hostable models and human contributors can use the same repository-owned files, commands, tools and scripts.

...
List<_NavDestination> _baseDestinations(AppLocalizations l10n) =>
    <_NavDestination>[
      _NavDestination(
...
_NavDestination _adminDestination(AppLocalizations l10n) => _NavDestination(

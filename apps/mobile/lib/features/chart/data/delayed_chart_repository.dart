...
class DelayedChartRepository extends HttpChartRepository {
  new({required super.api, super.now, AppRuntimeConfig? appRuntimeConfig})
  ...
  Future<List<ChartPoint>> fetchTrendingCounts() async {
    if (_config.isDev) {
      await Future<void>.delayed(_config.skeletonDelay);
    }
    return await super.fetchTrendingCounts();
  }
}

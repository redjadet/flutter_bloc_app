...
mixin _$GraphqlBodyData {
 ...
 bool get isLoading; bool get hasError; List<GraphqlCountry> get countries; AppError? get lastError;
...
@override
int get hashCode => Object.hash(runtimeType,isLoading,hasError,const DeepCollectionEquality().hash(countries),lastError);

@override
String toString() {
  return 'GraphqlBodyData(isLoading: $isLoading, hasError: $hasError, countries: $countries, lastError: $lastError)';
}
...
@useResult
$Res call({
 bool isLoading, bool hasError, List<GraphqlCountry> countries, AppError? lastError
});
...
/// Create a copy of GraphqlBodyData
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? isLoading = null,Object? hasError = null,Object? countries = null,Object? lastError = freezed,}) {
  return _then(_self.copyWith(
...
as List<GraphqlCountry>,lastError: freezed == lastError ? _self.lastError : lastError // ignore: cast_nullable_to_non_nullable
as AppError?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool isLoading,  bool hasError,  List<GraphqlCountry> countries,  AppError? lastError)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GraphqlBodyData() when $default != null:
return $default(_that.isLoading,_that.hasError,_that.countries,_that.lastError);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool isLoading,  bool hasError,  List<GraphqlCountry> countries,  AppError? lastError)  $default,) {final _that = this;
switch (_that) {
case _GraphqlBodyData():
return $default(_that.isLoading,_that.hasError,_that.countries,_that.lastError);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool isLoading,  bool hasError,  List<GraphqlCountry> countries,  AppError? lastError)?  $default,) {final _that = this;
switch (_that) {
case _GraphqlBodyData() when $default != null:
return $default(_that.isLoading,_that.hasError,_that.countries,_that.lastError);case _:
  return null;
...
class _GraphqlBodyData implements GraphqlBodyData {
  const _GraphqlBodyData({required this.isLoading, required this.hasError, required  List<GraphqlCountry> countries, this.lastError}): _countries = countries;
...
@override
int get hashCode => Object.hash(runtimeType,isLoading,hasError,const DeepCollectionEquality().hash(_countries),lastError);
...
/// Create a copy of GraphqlBodyData
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? isLoading = null,Object? hasError = null,Object? countries = null,Object? lastError = freezed,}) {

...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _MarketStats value)?  $default,{required TResult orElse(),}){final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _MarketStats value)  $default,){final _that = this;
switch (_that) {
case _MarketStats():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _MarketStats value)?  $default,){final _that = this;
switch (_that) {
case _MarketStats() when $default != null:
return $default(_that);case _:
  return null;

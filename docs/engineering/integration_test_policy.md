...
- New integration scenarios must map to a named journey in
  [`engineering/integration_journey_map.md`](engineering/integration_journey_map.md).
...
- Track manual metrics in [`engineering/integration_metrics_baseline.md`](engineering/integration_metrics_baseline.md).

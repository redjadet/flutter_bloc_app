...
- **Register dispose callbacks** in `apps/mobile/lib/app/composition/injector_registrations.dart` for repositories that need cleanup (called from `configureDependencies()`)

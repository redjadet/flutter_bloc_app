...
| System design | App shell composes route-scoped features; domain contracts hide storage, HTTP, Firebase, Supabase, platform channels, and sync queues. | [`lib/core/bootstrap/bootstrap_coordinator.dart`](../lib/core/bootstrap/bootstrap_coordinator.dart), [`lib/core/di/injector_registrations.dart`](../lib/core/di/injector_registrations.dart), [`lib/app/router/routes.dart`](../lib/app/router/routes.dart) |
...
| Offline-first repositories | User actions persist locally, then replay through a queue when network/backend is ready. | [`adr/0002-offline-first-data.md`](adr/0002-offline-first-data.md), [`lib/shared/sync/pending_sync_repository.dart`](../lib/shared/sync/pending_sync_repository.dart), [`lib/shared/sync/background_sync_coordinator.dart`](../lib/shared/sync/background_sync_coordinator.dart) |
| Deferred routed features | Heavy or infrequent demos do not bloat initial route cost. | [`adr/0003-deferred-feature-loading.md`](adr/0003-deferred-feature-loading.md), [`lib/app/router/deferred_pages/`](../lib/app/router/deferred_pages/) |
...
| Incident triage | Structured error codes, `AppLogger`, Crashlytics handlers, sync diagnostics UI. | [`observability.md`](observability.md), [`lib/shared/utils/error_codes.dart`](../lib/shared/utils/error_codes.dart), [`lib/features/settings/presentation/widgets/sync_diagnostics_section.dart`](../lib/features/settings/presentation/widgets/sync_diagnostics_section.dart) |
...
| Local sensitive storage | `SecretStorage` wraps secure storage; Apple debug uses in-memory fallback because simulator Keychain is unreliable. | [`lib/shared/platform/secure_secret_storage.dart`](../lib/shared/platform/secure_secret_storage.dart), [`engineering/apple_debug_hive_storage.md`](engineering/apple_debug_hive_storage.md) |
| Auth routing | Global redirect handles app entry; route-level auth gates remain required for protected deep links. | [`lib/app/router/auth_redirect.dart`](../lib/app/router/auth_redirect.dart), [`lib/app/router/route_auth_policy.dart`](../lib/app/router/route_auth_policy.dart) |
| Backend caller auth | Render orchestration uses Firebase caller auth plus a dedicated HF token header; Remote Config is documented as client config, not a secret store. | [`docs/integrations/render_fastapi_chat_demo.md`](integrations/render_fastapi_chat_demo.md), [`lib/features/chat/data/render_fastapi_chat_repository_send.part.dart`](../lib/features/chat/data/render_fastapi_chat_repository_send.part.dart) |

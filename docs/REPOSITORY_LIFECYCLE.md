...
- **Main file:** `apps/mobile/lib/app/composition/injector.dart` - Contains `configureDependencies()` and public API
- **Registrations:** `apps/mobile/lib/app/composition/injector_registrations.dart` - Contains all dependency registrations organized by category
- **Factories:** `apps/mobile/lib/app/composition/injector_factories.dart` - Contains factory functions for creating repositories
- **Helpers:** `apps/mobile/lib/app/composition/injector_helpers.dart` - Contains helper functions for registration

...
| `./bin/checklist-fast` | 0 | Doc-gardening + fixture contract lane |
| `bash tool/check_lifecycle_observer_dispose.sh` | 0 | warn mode; 0 violations |
| `bash tool/check_deferred_heavy_routes.sh` | 0 | warn mode; allowlist OK |
| `bash tool/modular_metrics.sh --cross-feature-only` | 0 | Cross-feature imports: none |

# AI-first engineering — build spec (historical)

> **Status:** Waves 1–2 and ARCH-001/002/003 **shipped** (PR #239, #240). For current state use [`PLAN.md`](../../PLAN.md) and [`ai_first_engineering_executive_summary.md`](ai_first_engineering_executive_summary.md).

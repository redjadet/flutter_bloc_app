...
- **Docs:** [`engineering/checklist_quality_gates_baseline.md`](../engineering/checklist_quality_gates_baseline.md), [`engineering/checklist_quality_gates_deferred.md`](../engineering/checklist_quality_gates_deferred.md), theme section in [`validation_scripts.md`](../validation_scripts.md), routing matrix update
...
**Plan closure:** M0–M4 complete; optional `check_presentation_build_method_size.sh` cancelled. **Deferred / rejected** work: [`engineering/checklist_quality_gates_deferred.md`](../engineering/checklist_quality_gates_deferred.md) (QG-D01–D10). MVP baseline: [`engineering/checklist_quality_gates_baseline.md`](../engineering/checklist_quality_gates_baseline.md).

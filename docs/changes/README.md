...
- [`2026-07-20_hybrid_async_utils_public_package.md`](2026-07-20_hybrid_async_utils_public_package.md): Extract async coalescers + request-id guard to public `ilkersevim_async_utils` (Git `v0.1.0`; Pub.dev deferred).

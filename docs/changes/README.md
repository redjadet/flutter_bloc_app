...
- [`2026-08-10_todo_list_rebuild_remeasure.md`](2026-08-10_todo_list_rebuild_remeasure.md): Todo list narrow-selector remeasure — selection isolation harness green; accept.

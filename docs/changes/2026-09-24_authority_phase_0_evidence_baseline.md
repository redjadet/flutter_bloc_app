...
| ~40 feature modules | 41 dirs under `apps/mobile/lib/features/` excluding `features.dart`; catalog [`feature_overview.md`](../feature_overview.md); AI report “35” excludes some infra demos — prefer overview + dir count for thesis | `77150a6d` |
| Filtered coverage ≥85% (badge ~86.8%) | `coverage/lcov.info` + scorecard gate; badge in README / `docs/CODE_QUALITY.md` | `77150a6d` |

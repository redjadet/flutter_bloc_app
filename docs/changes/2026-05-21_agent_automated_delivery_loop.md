...
| 2 | Commit + push | Feature scope only; **omit** local coverage/coverage_summary (generated, gitignored) and README badge churn from `./bin/checklist` unless intentionally shipping coverage |

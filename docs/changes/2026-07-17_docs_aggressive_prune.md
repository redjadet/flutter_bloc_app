...
| todo list Firebase RTDB plan | [`todo_list_firebase_security_rules.md`](../security/todo_list_firebase_security_rules.md) |
| sealed classes migration essay | [`compile_time_safety.md`](../architecture/compile_time_safety.md), [`bloc_standards.md`](../bloc_standards.md) |
| migration to type-safe BLoC essay | [`compile_time_safety.md`](../architecture/compile_time_safety.md) |
| equatable to freezed conversion essay | [`freezed_usage_analysis.md`](../architecture/freezed_usage_analysis.md) |
...
| migration/isar vs hive comparison | Hive SoT; [`tradeoffs_and_future.md`](../architecture/tradeoffs_and_future.md) |
...
| remaining tasks plan (archive stub) | [`compile_time_safety.md`](../architecture/compile_time_safety.md) |
...
- [`walletconnect_auth_status.md`](../integrations/walletconnect_auth_status.md)

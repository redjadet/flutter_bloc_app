...
| Secrets (tokens, API keys) | `flutter_secure_storage` via `FlutterSecureSecretStorage` | `lib/shared/platform/secure_secret_storage.dart` |
...
See [plugin_failure_mode_strategy.md](plugin_failure_mode_strategy.md) for wrapper and `Result` conventions.

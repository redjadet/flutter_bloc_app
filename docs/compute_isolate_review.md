...
**Location:** `apps/mobile/lib/features/chart/data/http_chart_repository.dart` (e.g. `fetchTrendingCounts`)
...
**Location:** `apps/mobile/lib/features/graphql_demo/data/countries_graphql_repository.dart:148`
...
- `apps/mobile/lib/features/chat/data/chat_local_data_source.dart:53-71`
- `apps/mobile/lib/features/chat/data/secure_chat_history_repository.dart:27`
...
**Location:** `apps/mobile/lib/features/chat/data/huggingface_api_client.dart`
...
**Location:** `apps/mobile/lib/features/search/data/search_cache_repository.dart`
...
**Location:** `apps/mobile/lib/features/profile/data/profile_cache_repository.dart`

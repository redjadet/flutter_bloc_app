...
| **Maintainability simplify leftovers** (Wave C presentation splits; staff clock-out partial `flags`) | Lower seam value / pre-existing wire — not mobile-backend hardening | [`backend/MOBILE_BACKEND_DEFERRED_WORK.md`](MOBILE_BACKEND_DEFERRED_WORK.md) (**MS-D01**, **MS-D02**) | UI touch for MS-D01; product/sync contract for MS-D02 |
...
- Draft event taxonomy and Mixpanel/Sentry seams in [`observability.md`](../observability.md)

...
| **B2** | Promote only proven leak classes from ignore list — **partial 2026-08-05** (ChatPage TEC+Scroll, CounterPage Confetti, TodoListPage Scroll+TEC) |
...
exclusions): [`changes/2026-07-17_memory_quality_deferred.md`](../changes/2026-07-17_memory_quality_deferred.md).

...
| Mixpanel / Sentry (nice) | **Not shipped** — ADR 0008 no-go; documented seams; Firebase Analytics only via consent-gated port | [observability.md](observability.md), [ADR 0008](adr/0008-sentry-go-no-go.md) | Interview appendix script §12 |

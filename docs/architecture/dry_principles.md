...
> - [Flutter Best Practices Review](../review/flutter_best_practices_review.md) - DRY principles review section
...
1. **Search existing codebase**: Check `apps/mobile/lib/app/` for existing
...
- [Shared Utilities](../engineering/SHARED_UTILITIES.md) — full catalog of shared
  code

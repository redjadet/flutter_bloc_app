...
[reference feature](reference_features.md). Do not compensate with
...
follow [Use Case and DTO Policy](use_case_dto_policy.md).
...
- [Feature Structure Contract](feature_structure_contract.md)
- [Reference Features](reference_features.md)
- [Use Case and DTO Policy](use_case_dto_policy.md)

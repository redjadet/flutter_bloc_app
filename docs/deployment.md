...
**Note:** `fastlane/README.md` is auto-generated by Fastlane and may show `[bundle exec] fastlane ...` examples. In this repo, prefer the canonical wrapper `./tool/fastlane.sh ...` to avoid Bundler/Ruby version drift (especially in CI and for AI agents).

...
6. **Docs + runbook**
   ...
   - Examples: [`offline_first/chat.md`](chat.md), [`offline_first/search.md`](search.md), [`offline_first/profile.md`](profile.md), and the new [`offline_first/remote_config.md`](remote_config.md).

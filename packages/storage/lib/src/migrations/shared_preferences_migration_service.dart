    ...
    await StorageGuard.run<void>(
      ...
      action: () async {
        ...
        try {
          ...
          AppLogger.error('Failed to migrate counter data', error, stackTrace);
        }
        ...
        try {
          ...
          AppLogger.error('Failed to migrate locale data', error, stackTrace);
        }
        ...
        try {
          ...
          AppLogger.error('Failed to migrate theme data', error, stackTrace);
        }

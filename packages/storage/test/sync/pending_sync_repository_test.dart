...
import '../hive_test_helpers.dart' as hive_test_helpers;
...
void main() {
  ...
  setUpAll(() async {
    await hive_test_helpers.setupHiveForTesting();
  });

  setUp(() async {
    hiveService = await hive_test_helpers.createHiveService();
  ...
  tearDown(() async {
    ...
    await hive_test_helpers.cleanupHiveBoxes(['pending_sync_operations']);
  });

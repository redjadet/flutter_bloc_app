...
class EpochThemeExtension extends ThemeExtension<EpochThemeExtension> {
  ...
  static const EpochThemeExtension _default = EpochThemeExtension(
    warmGreyLightest: EpochColors.warmGreyLightest,
    warmGrey: EpochColors.warmGrey,
    ash: EpochColors.ash,
    ashDarker: EpochColors.ashDarker,
    darkGrey: EpochColors.darkGrey,
    pink: EpochColors.pink,
    purple: EpochColors.purple,
  );
  ...
  EpochThemeExtension lerp(
    ...
    return EpochThemeExtension(
      warmGreyLightest: _lerpColor(warmGreyLightest, other.warmGreyLightest, t),

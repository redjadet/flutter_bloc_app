  ...
  return MixScope.withMaterial(
    ...
    breakpoints: {
      BreakpointToken.mobile: const Breakpoint(
        maxWidth: LayoutBreakpoints.mobileBreakpoint - 1,
      ),
      BreakpointToken.tablet: const Breakpoint(
        minWidth: LayoutBreakpoints.mobileBreakpoint,
        maxWidth: LayoutBreakpoints.tabletBreakpoint - 1,
      ),
      BreakpointToken.desktop: const Breakpoint(
        minWidth: LayoutBreakpoints.tabletBreakpoint,
      ),
    },
    child: child,
  );

...
void main() {
  ...
  testWidgets('Try again after unsupported real mode returns to mock showcase', (
    final tester,
  ) async {
    final MockBleRepository mockRepository = MockBleRepository();
    final MockClassicBluetoothRepository classicRepository = MockClassicBluetoothRepository();
    final IotBleCubit cubit = IotBleCubit(
      mockRepository: mockRepository,
      reactiveRepository: const UnsupportedBleRepository(),
      classicRepository: classicRepository,
    ...
    expect(find.textContaining(l10n.iotBleErrorUnsupportedPlatform), findsOneWidget);

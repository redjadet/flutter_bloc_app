...
| Native interop (MethodChannel / EventChannel / FFI) | [`apps/mobile/lib/features/native_platform_showcase/`](apps/mobile/lib/features/native_platform_showcase/), [`README`](apps/mobile/lib/features/native_platform_showcase/README.md), [`docs/architecture/reference_features.md`](docs/architecture/reference_features.md) (`native_platform_showcase` row); Rust FFI demo: [`packages/secure_core_bridge/`](packages/secure_core_bridge/), [`docs/features/secure_messaging_demo.md`](docs/features/secure_messaging_demo.md) |

...
require_file "tool/agent_host_templates/shared/skills/agents-regression-capture/SKILL.md"
...
require_contains "docs/ai/skill_routing.md" "agents-regression-capture"
require_contains "docs/ai/skill_routing.md" "agents-aidlc-workflow"
require_contains "tool/agent_asset_lib.sh" "agents-create-cubit"
require_contains "tool/agent_asset_lib.sh" "agents-regression-capture"
require_contains "tool/agent_asset_lib.sh" "agents-aidlc-workflow"
...
require_contains "docs/ai/context_loading.md" "aidlc_workflow.md"

...
managed_cursor_files=(
  ...
  "shared/skills/agents-aidlc-workflow/SKILL.md|$HOME/.cursor/skills/agents-aidlc-workflow/SKILL.md"
...
managed_codex_files=(
  ...
  "shared/skills/agents-aidlc-workflow/SKILL.md|$HOME/.codex/skills/flutter-bloc-app-aidlc-workflow/SKILL.md"

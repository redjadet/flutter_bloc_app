...
managed_cursor_files=(
  ...
  "cursor/skills/verification-before-completion/SKILL.md|$HOME/.cursor/skills/verification-before-completion/SKILL.md"
  "cursor/skills/test-driven-development/SKILL.md|$HOME/.cursor/skills/test-driven-development/SKILL.md"
  ...
  "cursor/skills/agents-repo-context/SKILL.md|$HOME/.cursor/skills/agents-repo-context/SKILL.md"
  "cursor/skills/agents-principles-baseline/SKILL.md|$HOME/.cursor/skills/agents-principles-baseline/SKILL.md"
  "cursor/skills/agents-references/SKILL.md|$HOME/.cursor/skills/agents-references/SKILL.md"
  "cursor/skills/agents-canonical-rules/SKILL.md|$HOME/.cursor/skills/agents-canonical-rules/SKILL.md"
  "cursor/skills/agents-canonical-rules-architecture/SKILL.md|$HOME/.cursor/skills/agents-canonical-rules-architecture/SKILL.md"
  "cursor/skills/agents-canonical-rules-presentation/SKILL.md|$HOME/.cursor/skills/agents-canonical-rules-presentation/SKILL.md"
  "cursor/skills/agents-canonical-rules-async/SKILL.md|$HOME/.cursor/skills/agents-canonical-rules-async/SKILL.md"
  "cursor/skills/agents-canonical-rules-platform/SKILL.md|$HOME/.cursor/skills/agents-canonical-rules-platform/SKILL.md"
  "cursor/skills/agents-validation-testing/SKILL.md|$HOME/.cursor/skills/agents-validation-testing/SKILL.md"
  "cursor/skills/agents-common-pitfalls/SKILL.md|$HOME/.cursor/skills/agents-common-pitfalls/SKILL.md"
  "cursor/skills/agents-figma/SKILL.md|$HOME/.cursor/skills/agents-figma/SKILL.md"
  "cursor/skills/figma-this-repo/SKILL.md|$HOME/.cursor/skills/figma-this-repo/SKILL.md"
  "cursor/skills/agents-modularity/SKILL.md|$HOME/.cursor/skills/agents-modularity/SKILL.md"
  "cursor/skills/agents-shared-patterns/SKILL.md|$HOME/.cursor/skills/agents-shared-patterns/SKILL.md"
  "cursor/skills/agents-supabase/SKILL.md|$HOME/.cursor/skills/agents-supabase/SKILL.md"

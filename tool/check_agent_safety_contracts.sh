...
if [[ "$owner_path" == "docs/agent_kb/agent_safety_contracts.md" ]]; then
  ...
  require_contains "docs/agent_kb/legibility_and_finish_gate.md" "What We Learned"
  require_contains "docs/ai/agent_operating_manual.md" "Understanding loop"
  ...
  require_contains "tool/agent_host_templates/cursor/rules/agent-execution.mdc" "What We Learned"

...
SHARED_PATH_REWRITES: dict[str, str] = {
    ...
    "shared/utils/stream_controller_lifecycle.dart": "package:ilkersevim_async_lifecycle/ilkersevim_async_lifecycle.dart",
    "shared/utils/completer_helper.dart": "package:ilkersevim_async_lifecycle/ilkersevim_async_lifecycle.dart",

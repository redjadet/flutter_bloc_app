...
CHECK_MESSAGES=(
  ...
  "Checking Hive getBox RMW stays inside runWithBox (lost-update)..."
  ...
  "Checking for sensitive values in logs..."
  ...
  "Checking Apple Keychain dual-store delete/read symmetry..."
...
CHECK_SCRIPTS=(
  ...
  "tool/check_sensitive_logging.sh"

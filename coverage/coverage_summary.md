...
*Total line coverage*: **84.07%** (9310/11074 lines)
...
| `lib/features/chat/presentation/widgets/chat_list_view.dart` | 41.67% | 35/84 |
...
| `lib/features/auth/presentation/widgets/register_form_styles.dart` | 85.00% | 17/20 |
...
| `lib/features/profile/presentation/widgets/profile_action_buttons.dart` | 92.31% | 24/26 |
...
| `lib/features/chart/presentation/pages/chart_page.dart` | 93.48% | 43/46 |
| `lib/shared/sync/background_sync_runner.dart` | 93.62% | 88/94 |
| `lib/shared/widgets/common_loading_widget.dart` | 93.75% | 45/48 |
| `lib/shared/widgets/common_form_field.dart` | 93.75% | 60/64 |
...
| `lib/shared/widgets/message_bubble.dart` | 96.88% | 31/32 |
...
| `lib/features/profile/presentation/pages/profile_page.dart` | 98.04% | 50/51 |
...
| `lib/shared/widgets/common_error_view.dart` | 100.00% | 25/25 |

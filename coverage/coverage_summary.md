...
*Total line coverage*: **74.83%** (10190/13618 lines)
...
| --- | ---: | ---: |
| `lib/features/todo_list/presentation/widgets/todo_sort_bar.dart` | 0.00% | 0/132 |
...
| `lib/features/todo_list/presentation/widgets/todo_list_view.dart` | 0.00% | 0/44 |
| `lib/features/todo_list/presentation/widgets/todo_empty_state.dart` | 0.00% | 0/8 |
| `lib/shared/widgets/type_safe_bloc_selector.dart` | 0.00% | 0/17 |
| `lib/shared/sync/sync_status.dart` | 0.00% | 0/3 |
| `lib/shared/extensions/type_safe_bloc_access.dart` | 0.00% | 0/19 |
...
| `lib/features/todo_list/presentation/widgets/todo_filter_bar.dart` | 0.00% | 0/40 |
...
| `lib/features/todo_list/presentation/pages/todo_list_page_data.dart` | 0.00% | 0/1 |
...
| `lib/features/library_demo/presentation/widgets/library_demo_theme.dart` | 0.00% | 0/44 |
...
| `lib/features/library_demo/presentation/widgets/library_demo_asset_tile.dart` | 0.00% | 0/63 |
...
| `lib/features/library_demo/presentation/widgets/library_demo_assets_header.dart` | 0.00% | 0/11 |
...
| `lib/features/library_demo/presentation/widgets/library_demo_icon_button.dart` | 0.00% | 0/15 |
| `lib/features/library_demo/presentation/widgets/library_demo_wordmark.dart` | 0.00% | 0/7 |
| `lib/features/library_demo/presentation/widgets/library_demo_top_nav.dart` | 0.00% | 0/13 |
...
| `lib/features/library_demo/presentation/widgets/library_demo_body.dart` | 1.30% | 1/77 |
...
| `lib/features/todo_list/presentation/widgets/todo_sync_banner.dart` | 2.86% | 1/35 |
| `lib/features/library_demo/presentation/pages/library_demo_page.dart` | 12.50% | 1/8 |
| `lib/features/library_demo/presentation/widgets/library_demo_view_icons.dart` | 16.67% | 2/12 |
| `lib/features/library_demo/presentation/widgets/library_demo_waveform.dart` | 16.67% | 1/6 |
...
| `lib/app/router/routes.dart` | 37.35% | 31/83 |
| `lib/shared/utils/state_transition_validator.dart` | 37.50% | 6/16 |
...
| `lib/shared/sync/syncable_repository_registry.dart` | 64.29% | 9/14 |
...
| `lib/features/example/presentation/pages/example_page.dart` | 67.82% | 59/87 |
...
| `lib/features/todo_list/presentation/widgets/todo_list_item.dart` | 82.14% | 46/56 |
...
| `lib/shared/widgets/common_empty_state.dart` | 84.21% | 16/19 |
...
| `lib/features/todo_list/presentation/cubit/todo_list_cubit_methods.dart` | 84.31% | 86/102 |
...
| `lib/shared/widgets/common_status_view.dart` | 85.19% | 23/27 |
...
| `lib/shared/widgets/common_input_decoration_helpers.dart` | 90.00% | 18/20 |
...
| `lib/shared/widgets/common_form_field.dart` | 93.85% | 61/65 |
...
| `lib/features/search/presentation/widgets/search_text_field.dart` | 100.00% | 43/43 |
...
| `lib/features/example/presentation/widgets/example_page_body.dart` | 100.00% | 82/82 |

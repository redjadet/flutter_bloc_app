...
*Total line coverage*: **76.59%** (11079/14465 lines)
...
| --- | ---: | ---: |
| `lib/features/genui_demo/data/genui_demo_agent_impl.dart` | 0.00% | 0/41 |
...
| `lib/features/example/presentation/pages/example_page.dart` | 67.05% | 59/88 |
...
| `lib/features/genui_demo/presentation/cubit/genui_demo_cubit.dart` | 71.70% | 76/106 |
...
| `lib/features/genui_demo/presentation/widgets/genui_demo_content.dart` | 81.08% | 60/74 |
...
| `lib/features/counter/data/realtime_database_counter_repository.dart` | 83.87% | 52/62 |
...
| `lib/core/di/injector_registrations.dart` | 85.00% | 51/60 |
...
| `lib/features/todo_list/data/realtime_database_todo_repository.dart` | 88.30% | 83/94 |

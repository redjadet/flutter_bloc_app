...
*Total line coverage*: **84.27%** (9520/11297 lines)
...
| --- | ---: | ---: |
| `lib/shared/widgets/sync_status_banner.dart` | 0.00% | 0/16 |
...
| `lib/app/router/routes.dart` | 29.76% | 25/84 |
...
| `lib/features/counter/presentation/pages/counter_page.dart` | 72.22% | 52/72 |
...
| `lib/features/counter/presentation/widgets/counter_sync_queue_inspector_button.dart` | 85.96% | 49/57 |
...
| `lib/app/app_scope.dart` | 100.00% | 44/44 |

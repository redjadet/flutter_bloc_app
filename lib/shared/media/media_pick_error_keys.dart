/// L10n error keys for media pick flows (camera, gallery, video).
abstract final class MediaPickErrorKeys {
  static const String permissionDenied = 'cameraGalleryPermissionDenied';

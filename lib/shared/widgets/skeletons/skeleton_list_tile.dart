...
///
/// Uses [AppStyles.listTile] for padding. Provides consistent loading state
/// for chat history, search results, etc. Includes semantic labels for
/// accessibility.

...
mixin _$CounterState {
 ...
 int get count; DateTime? get lastChanged; DateTime? get lastSyncedAt; String? get changeId; int get countdownSeconds; CounterError? get error; ViewStatus get status; int get pendingSyncCount;
...
@override
int get hashCode => Object.hash(runtimeType,count,lastChanged,lastSyncedAt,changeId,countdownSeconds,error,status,pendingSyncCount);

@override
String toString() {
  return 'CounterState(count: $count, lastChanged: $lastChanged, lastSyncedAt: $lastSyncedAt, changeId: $changeId, countdownSeconds: $countdownSeconds, error: $error, status: $status, pendingSyncCount: $pendingSyncCount)';
}
...
@useResult
$Res call({
 int count, DateTime? lastChanged, DateTime? lastSyncedAt, String? changeId, int countdownSeconds, CounterError? error, ViewStatus status, int pendingSyncCount
});
...
/// Create a copy of CounterState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? count = null,Object? lastChanged = freezed,Object? lastSyncedAt = freezed,Object? changeId = freezed,Object? countdownSeconds = null,Object? error = freezed,Object? status = null,Object? pendingSyncCount = null,}) {
...
as ViewStatus,pendingSyncCount: null == pendingSyncCount ? _self.pendingSyncCount : pendingSyncCount // ignore: cast_nullable_to_non_nullable
as int,
  ));
}
/// Create a copy of CounterState
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int count,  DateTime? lastChanged,  DateTime? lastSyncedAt,  String? changeId,  int countdownSeconds,  CounterError? error,  ViewStatus status,  int pendingSyncCount)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CounterState() when $default != null:
return $default(_that.count,_that.lastChanged,_that.lastSyncedAt,_that.changeId,_that.countdownSeconds,_that.error,_that.status,_that.pendingSyncCount);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int count,  DateTime? lastChanged,  DateTime? lastSyncedAt,  String? changeId,  int countdownSeconds,  CounterError? error,  ViewStatus status,  int pendingSyncCount)  $default,) {final _that = this;
switch (_that) {
case _CounterState():
return $default(_that.count,_that.lastChanged,_that.lastSyncedAt,_that.changeId,_that.countdownSeconds,_that.error,_that.status,_that.pendingSyncCount);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int count,  DateTime? lastChanged,  DateTime? lastSyncedAt,  String? changeId,  int countdownSeconds,  CounterError? error,  ViewStatus status,  int pendingSyncCount)?  $default,) {final _that = this;
switch (_that) {
case _CounterState() when $default != null:
return $default(_that.count,_that.lastChanged,_that.lastSyncedAt,_that.changeId,_that.countdownSeconds,_that.error,_that.status,_that.pendingSyncCount);case _:
  return null;
...
class _CounterState extends CounterState {
  const _CounterState({required this.count, this.lastChanged, this.lastSyncedAt, this.changeId, this.countdownSeconds = CounterState.defaultCountdownSeconds, this.error, this.status = ViewStatus.initial, this.pendingSyncCount = 0}): super._();
...
/// Create a copy of CounterState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? count = null,Object? lastChanged = freezed,Object? lastSyncedAt = freezed,Object? changeId = freezed,Object? countdownSeconds = null,Object? error = freezed,Object? status = null,Object? pendingSyncCount = null,}) {

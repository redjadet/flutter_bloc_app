...
mixin _$GraphqlDemoState {
 ...
 GraphqlDemoStatus get status; List<GraphqlCountry> get countries; List<GraphqlContinent> get continents; String? get activeContinentCode; String? get errorMessage;
...
@override
int get hashCode => Object.hash(runtimeType,status,const DeepCollectionEquality().hash(countries),const DeepCollectionEquality().hash(continents),activeContinentCode,errorMessage);

@override
String toString() {
  return 'GraphqlDemoState(status: $status, countries: $countries, continents: $continents, activeContinentCode: $activeContinentCode, errorMessage: $errorMessage)';
}
...
@useResult
$Res call({
 GraphqlDemoStatus status, List<GraphqlCountry> countries, List<GraphqlContinent> continents, String? activeContinentCode, String? errorMessage
});
...
/// Create a copy of GraphqlDemoState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? status = null,Object? countries = null,Object? continents = null,Object? activeContinentCode = freezed,Object? errorMessage = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( GraphqlDemoStatus status,  List<GraphqlCountry> countries,  List<GraphqlContinent> continents,  String? activeContinentCode,  String? errorMessage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GraphqlDemoState() when $default != null:
return $default(_that.status,_that.countries,_that.continents,_that.activeContinentCode,_that.errorMessage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( GraphqlDemoStatus status,  List<GraphqlCountry> countries,  List<GraphqlContinent> continents,  String? activeContinentCode,  String? errorMessage)  $default,) {final _that = this;
switch (_that) {
case _GraphqlDemoState():
return $default(_that.status,_that.countries,_that.continents,_that.activeContinentCode,_that.errorMessage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( GraphqlDemoStatus status,  List<GraphqlCountry> countries,  List<GraphqlContinent> continents,  String? activeContinentCode,  String? errorMessage)?  $default,) {final _that = this;
switch (_that) {
case _GraphqlDemoState() when $default != null:
return $default(_that.status,_that.countries,_that.continents,_that.activeContinentCode,_that.errorMessage);case _:
  return null;
...
class _GraphqlDemoState extends GraphqlDemoState {
  const _GraphqlDemoState({this.status = GraphqlDemoStatus.initial, final  List<GraphqlCountry> countries = const <GraphqlCountry>[], final  List<GraphqlContinent> continents = const <GraphqlContinent>[], this.activeContinentCode, this.errorMessage}): _countries = countries,_continents = continents,super._();
...
@override
int get hashCode => Object.hash(runtimeType,status,const DeepCollectionEquality().hash(_countries),const DeepCollectionEquality().hash(_continents),activeContinentCode,errorMessage);
...
/// Create a copy of GraphqlDemoState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? status = null,Object? countries = null,Object? continents = null,Object? activeContinentCode = freezed,Object? errorMessage = freezed,}) {

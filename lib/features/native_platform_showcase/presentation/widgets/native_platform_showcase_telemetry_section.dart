...
class NativePlatformShowcaseTelemetrySection extends StatelessWidget {
  ...
  Widget build(final BuildContext context) {
    ...
    >(
      selector: (final state) => state.mapOrNull(loaded: (final loaded) => loaded.telemetry),
        ...
        return KeyedSubtree(
          ...
          child: CommonCard(
            child: Column(
              ...
              children: <Widget>[
                Text(l10n.nativePlatformShowcaseTelemetryTitle, style: theme.textTheme.titleMedium),
...
class _TelemetryBody extends StatelessWidget {
  const _TelemetryBody({required this.telemetry, required this.l10n, required this.theme});

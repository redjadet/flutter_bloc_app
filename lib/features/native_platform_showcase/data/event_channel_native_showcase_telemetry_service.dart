...
class EventChannelNativeShowcaseTelemetryService implements NativeShowcaseTelemetryService {
  EventChannelNativeShowcaseTelemetryService({final Stream<Object?> Function()? events})
    : _events =
          events ??
  ...
  static NativeShowcaseTelemetrySnapshot? _mapEvent(final Object? event) {
    ...
    return NativeShowcaseTelemetrySnapshot(
      ...
      emittedAt: DateTime.fromMillisecondsSinceEpoch(emittedAtMillis, isUtc: true).toLocal(),
    );
  }

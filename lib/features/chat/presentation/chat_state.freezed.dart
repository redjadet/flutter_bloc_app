...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(messages),isLoading,error,const DeepCollectionEquality().hash(pastUserInputs),const DeepCollectionEquality().hash(generatedResponses),currentModel,const DeepCollectionEquality().hash(history),activeConversationId,status);

@override
String toString() {
  return 'ChatState(messages: $messages, isLoading: $isLoading, error: $error, pastUserInputs: $pastUserInputs, generatedResponses: $generatedResponses, currentModel: $currentModel, history: $history, activeConversationId: $activeConversationId, status: $status)';
}
...
/// Create a copy of ChatState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? messages = null,Object? isLoading = null,Object? error = freezed,Object? pastUserInputs = null,Object? generatedResponses = null,Object? currentModel = freezed,Object? history = null,Object? activeConversationId = freezed,Object? status = null,}) {
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_messages),isLoading,error,const DeepCollectionEquality().hash(_pastUserInputs),const DeepCollectionEquality().hash(_generatedResponses),currentModel,const DeepCollectionEquality().hash(_history),activeConversationId,status);
...
/// Create a copy of ChatState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? messages = null,Object? isLoading = null,Object? error = freezed,Object? pastUserInputs = null,Object? generatedResponses = null,Object? currentModel = freezed,Object? history = null,Object? activeConversationId = freezed,Object? status = null,}) {

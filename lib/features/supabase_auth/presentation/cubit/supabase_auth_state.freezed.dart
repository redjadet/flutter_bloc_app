...
class _Loading implements SupabaseAuthState {
  const _Loading();
...
@override
String toString() {
  return 'SupabaseAuthState.loading()';
}
...
class _Authenticated implements SupabaseAuthState {
...
@override
String toString() {
  return 'SupabaseAuthState.authenticated(user: $user)';
}
...
/// @nodoc
abstract mixin class _$AuthenticatedCopyWith<$Res> implements $SupabaseAuthStateCopyWith<$Res> {
...
class _Unauthenticated implements SupabaseAuthState {
...
class _Error implements SupabaseAuthState {
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $SupabaseAuthStateCopyWith<$Res> {
...
class _NotConfigured implements SupabaseAuthState {
...
@override
String toString() {
  return 'SupabaseAuthState.notConfigured()';
}
